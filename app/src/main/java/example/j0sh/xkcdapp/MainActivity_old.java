    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        prev_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (current_comic > 0) {
                    current_comic--;
                    new SetComic(MainActivity_old.this).execute(current_comic);
                }
            }
        });
        ...
        alt_text_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new GetAltText(MainActivity_old.this).execute(current_comic);
            }
        });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            case R.id.action_comic_label:
                ...
                dialog.setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        new SetComic(MainActivity_old.this).execute(comic_num);
                    }
                });
                dialog.show();
                return true;
            case R.id.action_random_comic:
                ...
                new SetComic(MainActivity_old.this).execute(next_comic);
                return true;
...
//                int permission = checkSelfPermission(Manifest.permission.WRITE_EXTERNAL_STORAGE);
    ...
    public void setImageViewByURL(String url) {
        ...
        /*start loading*/
        MainActivity_old.this.setLoading(true);
        Glide.with(this).load(url).listener(new RequestListener<String, GlideDrawable>() {
            @Override
            public boolean onException(Exception e, String model, Target<GlideDrawable> target, boolean isFirstResource) {
                /*reset the loader if we get an exception*/
                MainActivity_old.this.setLoading(false);
                return false;
            }
